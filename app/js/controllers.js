    ...
    $scope.colorize = function(cm, tiledImage){
        ...
        if(tiledImage == null){
            ...
            for (var i = 0; i < $scope.filters.length; i++) {
                ...
                if (f.items == tiledImage){
                    $scope.filters[i].processors = [OpenSeadragon.Filters.COLORMAP(cmap, 128)];
                    found = true;
                }
            }
            if(!found){
    ...
    $scope.watchProc = function(id, key){
        $scope.watchers[id] = $interval(function() {
            ...
            $scope.$on('$destroy',function(){
                var promise = $scope.watchers[id];
                if(promise) $interval.cancel($scope.watchers[id]);
            });
    }
